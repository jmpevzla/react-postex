...
function AboutMe() {
  return (
    <div className="flex flex-col text-center select-none 
        h-[calc(100vh_-_3rem)] justify-center">
      <h1 className="mb-4 text-5xl tracking-widest 
        font-extrabold [text-shadow:0_4px_8px_rgba(0,0,0,0.25)]">About Me</h1>
      <div className="
        ...
        <p className="italic font-bold text-sm mb-2">
          <a className="link" href="https://twitter.com/jmpevzla" rel="noopener noreferrer" target="_blank">
            <Icon className="inline" path={mdiTwitter} size="1.5rem" /><span>Twitter</span>
          </a>
        </p>
        <p className="italic font-bold text-sm">
          <a className="link" href="https://github.com/jmpevzla" rel="noopener noreferrer" target="_blank">
            <Icon className="inline" path={mdiGithub} size="1.5rem" /><span>Github</span>
          </a>
        </p>
      </div>
    </div>
